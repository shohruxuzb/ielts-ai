...
import { BookOpen, Headphones, FileText, Mic, Award, Star, Sparkles, Trophy, TrendingUp, Users } from "lucide-react";
        ...
        <div className="mb-16 animate-fade-up">
          <div className="relative bg-gradient-to-br from-card via-card to-primary/5 rounded-3xl p-10 shadow-strong border-2 border-primary/20 hover:shadow-strong hover:scale-[1.02] transition-all duration-500 overflow-hidden">
            ...
            <div className="text-center relative z-10">
              ...
              <Button size="lg" className="bg-gradient-primary hover:opacity-90 text-primary-foreground font-semibold px-8 py-6 text-lg rounded-full shadow-medium hover:shadow-strong transition-all duration-300" asChild>
                <Link to="/courses">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            return (
              ...
              >
                <div className={`relative bg-gradient-to-br ${course.bgGradient} to-card rounded-3xl p-8 shadow-soft border border-border/50 hover:shadow-strong hover:-translate-y-2 transition-all duration-500 overflow-hidden h-full`}>
                  ...
                  <div className="relative z-10">
                    <div className={`w-20 h-20 bg-gradient-to-br ${course.gradient} rounded-3xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-medium`}>
